...
/**
 * This is the item provider adapter for a {@link study.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNumYearsPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyPackage.Literals.PROGRAM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_code_feature", "_UI_Program_type"),
				 StudyPackage.Literals.PROGRAM__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Num Years feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumYearsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_numYears_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_numYears_feature", "_UI_Program_type"),
				 StudyPackage.Literals.PROGRAM__NUM_YEARS,
				 true,
				 false,
				 false,
	...
	protected void addSpecialisationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_specialisations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_specialisations_feature", "_UI_Program_type"),
				 StudyPackage.Literals.PROGRAM__SPECIALISATIONS,
				 true,
				 false,
				 true,
				 null,
