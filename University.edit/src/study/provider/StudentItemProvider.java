...
/**
 * This is the item provider adapter for a {@link study.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyPackage.Literals.STUDENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSpecialisationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Student_specialisations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Student_specialisations_feature", "_UI_Student_type"),
				 StudyPackage.Literals.STUDENT__SPECIALISATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyPackage.Literals.STUDENT__STUDY_PLAN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.STUDENT__STUDY_PLAN,
				 StudyFactory.eINSTANCE.createStudyPlan()));
	}
