...
/**
 * This is the item provider adapter for a {@link study.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyPackage.Literals.DEPARTMENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyPackage.Literals.DEPARTMENT__CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyPackage.Literals.DEPARTMENT__COURSES);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.DEPARTMENT__COURSES,
				 StudyFactory.eINSTANCE.createCourse()));

		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.DEPARTMENT__PROGRAMS,
				 StudyFactory.eINSTANCE.createProgram()));

		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.DEPARTMENT__STUDENTS,
				 StudyFactory.eINSTANCE.createStudent()));
