...
/**
 * This is the item provider adapter for a {@link study.StudyPlan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudyPlanItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyPackage.Literals.STUDY_PLAN__SEMESTER);
			childrenFeatures.add(StudyPackage.Literals.STUDY_PLAN__COURSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.STUDY_PLAN__SEMESTER,
				 StudyFactory.eINSTANCE.createSemester()));

		newChildDescriptors.add
			(createChildParameter
				(StudyPackage.Literals.STUDY_PLAN__COURSES,
				 StudyFactory.eINSTANCE.createcourseAllocation()));
	}
